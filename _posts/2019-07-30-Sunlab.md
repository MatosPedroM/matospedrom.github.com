...
For a baseline model we defined a simple Liner Regression with a resulting R2 of 0.75 (test set).

Then we built a Random Forest model with a resulting on a R2 of 0.89 (test set).
